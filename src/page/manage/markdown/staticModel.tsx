...
const modelComponents = (userOptions: SelectProps['options'], tagOptions: SelectProps['options']): IFormItemProps[] => {
  return [
    {
      label: '作者',
      name: 'authorId',
    ...
    },
    {
      label: '卡片背景',
      name: 'backgroundUrl',
      element: <Upload uploadText='上传封面' request={(file) => upload({ file })} />
    }
  ];
};
