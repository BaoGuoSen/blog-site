  ...
  return (
    <div className={styles.wrapper}>
      ...
      <div className={styles.users}>
        {users.map(
          ({ avatar, name, github, desc, id, totalViewCount, backgroundUrl }) => (
            <Box3D
              key={id}
              size={240}
              animation
              ...
              text={{
                  ...
                  children: (
                    <div>
                      ...
                      <div className={styles.extra}>
                        <span>文章阅读量:</span>
                        <span className={styles.total}>{totalViewCount.toLocaleString()}</span>
                      </div>
                    </div>
                  )
                },
                ...
                back: {
                  children: (
                    backgroundUrl && <img src={backgroundUrl} className={styles.background} />
                  )
                }
              }}
            />
